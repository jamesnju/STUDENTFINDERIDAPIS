...
export const getAllReportedLostIDs = async (req: Request, res: Response) => {
  try {
...
///var/task/src/uploads
// Delete FoundID by ID
export const deleteReportedLostIDs = async (req: Request, res: Response) => {
    const { id } = req.params;
